    ...
    <div className="login-page">
        ...
        <div className="left-panel__mask">
          <div className="panelTop-content">
            ...
            <div className="panelTop__div">
              <button className="panelTop__signUpBtn" type="button" onClick={onSwitchToRegister}>
                Sign Up
              </button>
              <button className="panelTop__loginBtn" type="button">
                Join Us
              </button>
            </div>
          </div>
      ...
      <div className="right-panel">
        ...
        <main className="login-card">
          ...
          <p className="subtitle">Hoje é aonde?</p>
          ...
          <form className="login-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <p className="signup">
              Não tem uma conta? <a onClick={onSwitchToRegister}>Sign up</a>
            </p>
